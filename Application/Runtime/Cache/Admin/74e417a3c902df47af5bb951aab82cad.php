...
<body class="iframe-body" data-sid="<?php echo ($adminRow["id"]); ?>" data-settime="<?php echo (C("IFRAME_BODY_SETTIME")); ?>" data-actionurl="/Admin/Enroll/addCollege">
    <div class="console-container ng-scope">
        ...
        <div class="row">
    <div class="col-sm-8">
        <form action="/admin/enroll/addCollege" method="POST" id="formData" data-ajax='true' class="form-horizontal autoBootstrapValidator">
            <div class="form-group">
                <label for="name" class="col-sm-3 control-label">学院名称：</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="name" check-type="required" placeholder="学院名称">
                </div>
            </div>
            <div class="form-group">
