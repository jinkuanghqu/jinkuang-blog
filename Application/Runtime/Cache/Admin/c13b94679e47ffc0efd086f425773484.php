...
<body class="iframe-body" data-sid="<?php echo ($adminRow["id"]); ?>" data-settime="<?php echo (C("IFRAME_BODY_SETTIME")); ?>" data-actionurl="/Admin/Enroll/enrollList">
                    ...
                    <div class="row panel-scroll">
                            ...
                            <div class="col-sm-12">
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            <th  class="center">参赛ID</th>
                                            <th class="center">参赛者</th>
                                            <th class="center">性别</th>
                                            <th class="center">电话</th>
                                            <th class="center">学院 / 单位</th>
                                            <th class="center">学号 / 身份证</th>
                                            <th class="center">参赛项目</th>
                                            <th class="center">比赛时间</th>
                                            <th class="center">比赛地点</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php if(is_array($enrollData)): $i = 0; $__LIST__ = $enrollData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$enrollData): $mod = ($i % 2 );++$i;?><tr class="info">
                                            <td><?php echo ($enrollData["id"]); ?></td>
                                            <td><?php echo ($enrollData["username"]); ?></td>
                                            <td><?php echo ($enrollData["sexy"]); ?></td>
                                            <td><?php echo ($enrollData["telphone"]); ?></td>
                                            <?php if($enrollData['identity'] == 1): ?><td><?php echo ($enrollData["college"]); ?></td>
                                                <td><?php echo ($enrollData["studentno"]); ?></td><?php endif; ?>
                                            <?php if($enrollData['identity'] == 2): ?><td><?php echo ($enrollData["company"]); ?></td>
                                                <td><?php echo ($enrollData["idcard"]); ?></td><?php endif; ?>
                                            <td><?php echo ($enrollData["title"]); ?></td>
                                            <td><?php echo ($enrollData["keywords"]); ?></td>
                                            <td><?php echo ($enrollData["description"]); ?></td>
