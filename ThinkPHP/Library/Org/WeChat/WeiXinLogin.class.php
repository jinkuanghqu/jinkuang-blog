...
class WeiXinLogin
{
     ...
     * @param string $state
     */
    function __construct($appid, $redirect_uri, $app_secret, $response_type = 'code', $scope = 'snsapi_userinfo ', $state = '12345')
    {
        //初始化
        $this->m_appid = $appid;
...
//         $url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=".$this->m_appid."&redirect_uri=".$this->m_redirect_uri."&response_type=
// code&scope=".$this->m_scope."&state=".$this->m_state."#wechat_redirect";
//         $this->http_request($url);
        header("location:https://open.weixin.qq.com/connect/oauth2/authorize?appid=".$this->m_appid."&redirect_uri=".$this->m_redirect_uri."&response_type=code&scope=".$this->m_scope."&state=".$this->m_state."#wechat_redirect");
    }
    ...
    public function http_request($url, $timeout = 300, $header = array())
    {
